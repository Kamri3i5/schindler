...
(() => {
  ...
  const T = {
    ru: {
      ...
      'prod.title': 'Четыре модели для каждой <em>задачи.</em>',
      ...
      'p60.tag': 'Премиум-коммерческий сегмент',
      'p60.desc': 'Премиальное решение для коммерческих и многофункциональных зданий с интенсивным пассажиропотоком. Гибкая адаптация габаритов шахты сочетается с почти бесшумным ходом благодаря регенеративному приводу.',
      'p60.s1l': 'Грузоподъёмность', 'p60.s1v': 'до 2 600 кг',
      'p60.s2l': 'Скорость', 'p60.s2v': '1.0–3.0 м/с',
      'p60.s3l': 'Этажей', 'p60.s3v': 'до 50',
      'p60.link': 'Подробнее о модели',
      'p60.h1l': 'Тип', 'p60.h1v': 'Пассажирский',
      'p60.h2l': 'Привод', 'p60.h2v': 'Безредукторный',
      'p60.h3l': 'Энергокласс', 'p60.h3v': 'A',
      'p60.h4l': 'Уровень шума', 'p60.h4v': '50–60 дБ',
      'p93.tag': 'Эскалаторы',
    ...
    uz: {
      ...
      'prod.title': 'Har bir vazifa uchun <em>to\'rtta model.</em>',
      ...
      'p60.tag': 'Premium-tijorat segmenti',
      'p60.desc': 'Yo\'lovchi trafigi yuqori bo\'lgan tijorat va ko\'p funksiyali binolar uchun premium yechim. Shaxta o\'lchamlarini moslashtirish imkoniyati regenerativ drayv tufayli deyarli sokin harakat bilan uyg\'unlashadi.',
      'p60.s1l': 'Yuk ko\'tarish', 'p60.s1v': '2 600 kg gacha',
      'p60.s2l': 'Tezlik', 'p60.s2v': '1.0–3.0 m/s',
      'p60.s3l': 'Qavatlar', 'p60.s3v': '50 tagacha',
      'p60.link': 'Model haqida batafsil',
      'p60.h1l': 'Turi', 'p60.h1v': 'Yo\'lovchi',
      'p60.h2l': 'Yurituvchi', 'p60.h2v': 'Reduktorsiz',
      'p60.h3l': 'Energiya klassi', 'p60.h3v': 'A',
      'p60.h4l': 'Shovqin darajasi', 'p60.h4v': '50–60 dB',
    ...
    en: {
      ...
      'prod.title': 'Four models for every <em>task.</em>',
      ...
      'p60.tag': 'Premium Commercial Segment',
      'p60.desc': 'A premium solution for commercial and mixed-use buildings with high passenger traffic. Flexible shaft dimensions pair with a near-silent ride thanks to a regenerative drive.',
      'p60.s1l': 'Capacity', 'p60.s1v': 'up to 2,600 kg',
      'p60.s2l': 'Speed', 'p60.s2v': '1.0–3.0 m/s',
      'p60.s3l': 'Floors', 'p60.s3v': 'up to 50',
      'p60.link': 'Model details',
      'p60.h1l': 'Type', 'p60.h1v': 'Passenger',
      'p60.h2l': 'Drive', 'p60.h2v': 'Gearless',
      'p60.h3l': 'Energy class', 'p60.h3v': 'A',
      'p60.h4l': 'Noise level', 'p60.h4v': '50–60 dB',
      'p93.tag': 'Escalators',
